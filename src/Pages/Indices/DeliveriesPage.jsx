...
const DeliveriesPage = () => {
  ...
  const [selectedTab, setSelectedTab] = useState("Date Wise");
  ...
  return (
    <SidebarAndNavbar>
      <div className="bg-white w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
        ...
        {/* Chart Section */}
        <div className="bg-white p-4 w-full overflow-x-auto scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100">
          {/* Tabs */}
          ...
          {selectedTab === "Date Wise" ? (
            <div className="">
              {/* Legend */}
              <div className="flex flex-wrap items-center gap-4 mb-4 text-xs md:ml-16">
              ...
              {/* Chart */}
              <div className="relative pl-6 pr-6 md:pl-[4.5rem] md:pr-32 w-full overflow-x-auto">
                {/* X-axis labels */}
                  ...
                  {data.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 h-5 relative">
                        ...
                        {/* Price and change */}
                        <div className="absolute right-2 md:-right-32 top-1/2 -translate-y-1/2 text-right px-3">
            ...
            <div className="text-center py-6">
              <h2 className="text-lg font-semibold">
                Looking for stocks within the Index with higher deliveries?
              </h2>
              <p className="text-sm text-gray-600">
                Subscribe to Pro Plan to find the stocks with high deliveries
              </p>
